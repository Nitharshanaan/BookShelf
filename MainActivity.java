...
public class MainActivity extends AppCompatActivity implements LoaderCallbacks<List<Books>> {
    ...
    //URL variable
    private static final String GOOGLE_Books_API = "https://www.googleapis.com/books/v1/volumes?maxResults=10&q=dog";
    ...
    @Override
    public void onLoadFinished(Loader<List<Books>> loader, List<Books> earthquakes) {
