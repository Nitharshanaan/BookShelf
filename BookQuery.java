...
public final class BookQuery {
    ...
    private static final String LOG_TAG = BookQuery.class.getSimpleName();

    private BookQuery() {
    }

    public static List<Books> fetchBookDetails(String requestUrl) {
    ...
    private static List<Books> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                // Create a new {@link Book} object with the title, author, image,
                // and publisher from the JSON response.
                Books book = new Books(title, authors, image, publisher);
            ...
            Log.e("BookQuery", "Problem parsing the book JSON results", e);
        }
